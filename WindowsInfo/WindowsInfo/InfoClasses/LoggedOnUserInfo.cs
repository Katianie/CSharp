...
{
    public class LoggedOnUserInfo : Info
    {
        public LoggedOnUserInfo() : base()
        {
        ...
        public override void LoadData()
        {
            ...
            myWMISearcher = new ManagementObjectSearcher("SELECT * FROM Win32_LoggedOnUser");
            ...
            while (collectionEnumerator.MoveNext())
            {
                ...
                currDictionary["Dependent"]    = Utils.Query("Dependent", myWMIQueryObject);
                currDictionary["Antecedent"]   = Utils.Query("Antecedent", myWMIQueryObject);
