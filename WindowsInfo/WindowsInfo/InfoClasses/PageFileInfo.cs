...
{
    public class PageFileInfo : Info
    {
        public PageFileInfo() : base()
        {
        ...
        public override void LoadData()
        {
            ...
            myWMISearcher = new ManagementObjectSearcher("SELECT * FROM Win32_PageFile");
            ...
            while (collectionEnumerator.MoveNext())
            {
                ...
                currDictionary["FreeSpace"]                 = Utils.Query("FreeSpace", myWMIQueryObject);
