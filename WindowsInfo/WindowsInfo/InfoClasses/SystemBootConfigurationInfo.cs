...
{
    public class SystemBootConfigurationInfo : Info
    {
        public SystemBootConfigurationInfo() : base()
        {
        ...
        public override void LoadData()
        {
            ...
            myWMISearcher = new ManagementObjectSearcher("SELECT * FROM Win32_SystemBootConfiguration");
            ...
            while (collectionEnumerator.MoveNext())
            {
                ...
                currDictionary["Element"]    = Utils.Query("Element", myWMIQueryObject);
                currDictionary["Setting"]    = Utils.Query("Setting", myWMIQueryObject);
